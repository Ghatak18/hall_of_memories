...
function App() {
  ...
  useEffect(() =>{
    fetch("nodejs-production-8bbc.up.railway.app/").then(res => res.json()).then((data) =>{
      setData1(data);
      console.log(data1);
  ...
  <div class="card">Card 3 content goes here</div>
    ...
    <div className="App">
      ...
      <div className='grid-container'>
        {
          data1.map(
            (data) => {
              return(<div className='card'><Peoples {...data}></Peoples></div>)
            }
          )
      ...
      <button className="button-87" role="button" onClick = {handleAdd}>Add Yourself</button>
